 ...
 */
public class MyWebChromeBingoClient extends WebChromeClient {
    ...
    public MyWebChromeBingoClient(IWebPageView mIWebPageView) {
        this.mIWebPageView = mIWebPageView;
        this.mActivity = (WebViewBingoActivity) mIWebPageView;
    }
