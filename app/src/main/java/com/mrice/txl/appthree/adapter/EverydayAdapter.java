...
import com.mrice.txl.appthree.databinding.ItemPurchaseOneBinding;
import com.mrice.txl.appthree.databinding.ItemPurchaseThreeBinding;
import com.mrice.txl.appthree.databinding.ItemPurchaseTitleBinding;
import com.mrice.txl.appthree.databinding.ItemPurchaseTwoBinding;
import com.mrice.txl.appthree.http.rx.RxBus;
import com.mrice.txl.appthree.http.rx.RxCodeConstants;
...
public class EverydayAdapter extends BaseRecyclerViewAdapter<List<AndroidBean>> {
    ...
    public BaseRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case TYPE_TITLE:
                return new TitleHolder(parent, R.layout.item_purchase_title);
            case TYPE_ONE:
                return new OneHolder(parent, R.layout.item_purchase_one);
            case TYPE_TWO:
                return new TwoHolder(parent, R.layout.item_purchase_two);
            default:
                return new ThreeHolder(parent, R.layout.item_purchase_three);
        }
    }

    private class TitleHolder extends BaseRecyclerViewHolder<List<AndroidBean>, ItemPurchaseTitleBinding> {
    ...
    private class OneHolder extends BaseRecyclerViewHolder<List<AndroidBean>, ItemPurchaseOneBinding> {
...
//                ImgLoadUtil.displayEspImage(object.get(0).getUrl(), binding.ivOnePhoto, 1);
    ...
    private class TwoHolder extends BaseRecyclerViewHolder<List<AndroidBean>, ItemPurchaseTwoBinding> {
    ...
    private class ThreeHolder extends BaseRecyclerViewHolder<List<AndroidBean>, ItemPurchaseThreeBinding> {
