package com.mrice.txl.appthree.model;

import android.text.TextUtils;

import com.mrice.txl.appthree.app.ConstantsImageUrl;
...
import com.mrice.txl.appthree.http.RequestImpl;
...
public class EverydayModel {
    ...
    public void showBanncerPage(final RequestImpl listener) {
        Subscription subscription = RetrofitHttpClient.Builder.getTingServer().getFrontpage()
    ...
    public void showRecyclerViewData(final RequestImpl listener) {
        ...
        Subscription subscription = RetrofitHttpClient.Builder.getGankIOServer().getGankIoDay(year, month, day)
