package com.mrice.txl.appthree.http.api;
...
public class MusicApiUtils {
    ...
    public static String KereaTag[] ={"bigbang","boshiii", "PSY", "李弘基", "李承哲","金钟国", "李孝利", "孝琳", "IU", "EXO", "T-ara", "东方神起", "Epik High", "Girl's Day", " 紫雨林", "Zebra"};
